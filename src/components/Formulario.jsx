...
const Formulario = () => {
   const {datos, handleChangeData, error, setError, cotizarSeguro} = useCotizador();
  ...
  return (
    <>
      ...
      >
        ...
        <div className="my-5">
            <label value={datos.year} className="block mb-3 font-bold text-gray-400 uppercase">
                Año
            </label>
            <select
            onChange={e => handleChangeData(e)}
            name="year" className="w-full p-3 bg-white border border-gray-200">
